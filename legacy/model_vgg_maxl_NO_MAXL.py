...
for index in range(total_epoch):
    ...
    for i in range(train_batch):
        ...
        # log_print max value in train_label[:, 2]
        # log_print(train_label[:, 2].max())
    ...
    with torch.no_grad():
        ...
        for i in range(test_batch):
            ...
            # log_print(test_label.shape)
            # log_print(test_label[:, 2].shape)
            # log_print max value in test_label[:, 2]
            # log_print(test_label[:, 2].max())
